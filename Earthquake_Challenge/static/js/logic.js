...
// tile layers that will be the background of our map.
...
function styleInfo(feature) {
  ...
  // circle based on the magnitude of the earthquake.
...
// create api link to tectonic plate data
...
d3.json(geoData).then(function(geoData) {
	console.log(geoData);
